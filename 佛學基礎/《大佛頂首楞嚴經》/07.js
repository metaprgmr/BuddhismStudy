...
m(37)+"薩婆、舍都嚧、你婆囉、若闍、" +
m(38)+"呼藍、突悉乏難、遮、那舍尼、" +
m(39)+"毖沙、舍悉怛囉、阿吉尼、烏陀迦囉、若闍、阿般囉視多、具囉、摩訶般囉、戰持、摩訶疊多、" +
m(40)+"摩訶帝闍、摩訶稅多、闍婆囉、摩訶跋囉、槃陀囉、婆悉你、" +
m(41)+"阿唎耶、多囉、毗唎俱知、誓婆、毗闍耶、跋闍囉、摩禮底、毗舍嚧多、" +
m(42)+"勃騰罔迦、跋闍囉、制喝那、阿遮、摩囉制婆、般囉質多、跋闍囉、擅持、毗舍囉、遮、扇多舍、鞞提婆、補視多" +
m(43)+"蘇摩嚧波、摩訶稅多" +
m(44)+"阿唎耶、多囉、摩訶婆囉、阿般囉、跋闍囉、商羯囉、制婆" +
m(45)+"跋闍囉、俱摩唎、俱藍陀唎、跋闍囉、喝薩多、遮、毗地耶、乾遮那、摩唎迦" +
m(46)+"啒蘇母婆羯、囉跢那、鞞嚧遮那、俱唎耶、夜囉菟、瑟尼釤、毗折藍婆、摩尼、遮、" +
m(47)+"跋闍囉、迦那迦、波囉婆、嚧闍那、跋闍囉、頓稚、遮、稅多、遮、迦摩囉、剎奢尸、波囉婆、" +
