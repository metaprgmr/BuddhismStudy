...
`
<h1 style="margin-bottom:-3px">《楞嚴經 The Śūraṅgama Sūtra》英中對照閱讀</h1>
...
<p>這是信裹居士將《楞嚴經》的英文翻譯與原經中文逐句乃至逐字對照，以利雙向了解經義。所採用的英文文本係陸寬昱居士（1898-1978）所作英文翻譯；該書的PDF可以很容易在網上找到，其封面如右。</p>

<p>據陸居士在書中前言的介紹，此翻譯是借助憨山大師（1546-1623）的註解（應該是《楞嚴經通議》，<a href="../index.html">首頁</a>有鏈接）進行的。原經中文版只是大致等量分為十卷，而陸居士將全經按照邏輯分成八部分，各部均冠以標題，乃至文本之中亦有更細標題，易於閱讀。標題似乎與憨山大師的科判並無直接關聯。下面把這八部分與十卷中文經文的關係作一個陳示。</p>

<p>不幸的是，陸居士沒有翻譯楞嚴咒的部分，乃至略去了有關持咒的經文。在此這些中文經文悉數保留，但是未敢作任何翻譯。在缺乏有效的咒語梵文的情況下，從中文音譯再音譯至其他語言，的確荒唐；這一點可以理解。另外，英文翻譯中尚有極少數遺漏的片句，基本無損經文原意；當是技術性遺失，或許在轉抄或出版時，等等。</p>

<!--
   1. English {pt}    1    2  3    4    5  M   6    7    8
                    -----  -  -  -----  -  -  ---  ---  ----
   2. Chinese {v}   1 2 3  4..4..4 5 6..6  7..7 8..8 9..9 10
-->
<center>
<table border="1px" cellspacing="0" cellpadding="2px" bgcolor="#fefefe">
...
<td><a class="lnk" href="?n=3">The Tathāgata Store Containing Both Noumenon & Phenomenon</a></td>
<td align="center" bgcolor="#e8e8e8">4</td>
</tr>

<tr>
<td align="center" rowspan="3">IV</td>
<td rowspan="3"><a class="lnk" href="?n=4">Self-Enlightenment</a></td>
<td align="center" bgcolor="#e8e8e8" style="border-bottom:0px">4</td>
</tr>
<tr>
...
<tr>
<td align="center" rowspan="2">VII</td>
<td rowspan="2"><a class="lnk" href="?n=7">The Six Planes of Existence Caused by Unenlightenment</a></td>
<td align="center" bgcolor="#e8e8e8" style="border-bottom:0px">8</td>
</tr>
<tr>
...
<tr>
<td align="center" rowspan="2">VIII</td>
<td rowspan="2"><a class="lnk" href="?n=8">Warning to Practisers: The Fifty False States Caused by the Five Aggregates</a></td>
<td align="center" bgcolor="#fff" style="border-bottom:0px">9</td>
</tr>
<tr>
...
<figure align="right">
<img src="Shurang-Lu-En.png" border="0" width="206px">
<figcaption style="font-size:12px; text-align:center">陸寬昱居士《楞嚴經》英文譯本封面</figcaption>
</figure>
</td></tr></table>
`);
