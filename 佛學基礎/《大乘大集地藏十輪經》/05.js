...
const this_book = new MyBookInfo('大乘大集地藏十輪經•卷五', '三藏法師玄奘奉詔譯')
...
「怛絰他(唐言謂)牟尼冐㘑(一)　牟那揭臘茷(二)　牟尼紇梨達曳(三)　牟尼嚧訶毘折(常列反)隸(四)　牟那曷栗制(五)　牟尼笈謎(六)　束訖羅博差(七)(初戒反)　鉢邏奢博差(八)(初戒反)　蜜羅博差(九)(初戒反)　騷剌婆紇栗帝(十)　妬剌拏紇栗折(章列反)隸(十一)　鉢怛邏叉紇栗帝(十二)　具具拏蜜隸(十三)　唈(烏合反)茷叉薩隸(十四)　遏怒訶祇[口*履]茷(十五)　牟尼鉢塔茷(十六)　莎訶(唐言善說)」
