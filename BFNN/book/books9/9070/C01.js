SongGSZ.volNum = 1;
SongGSZ.volTitle = '序•譯經篇第一之一';
SongGSZ.noLeadingAuthor = true;
SongGSZ.text = `
/TEXT030C/<a#a_001>宋高僧傳序</a>　　<a#a_002>卷一</a>

/VOLSEP/
/SECTION/進《高僧傳》表

/SECTION/端拱元年十月日左街天壽寺通慧大師賜紫臣僧贊寧上表
...
譯經篇第一<ail>（變梵成華。通凡入聖。法輪斯轉。諸佛所師。）</ail>
義解篇第二<ail>（尋文見義。得意忘言。三慧克全。二依當轉。）</ail>
習禪篇第三<ail>（修至無念。善惡都亡。亡其所亡。常住安樂。）</ail>
明律篇第四<ail>（嚴而少恩。正而急護。嬰守三業。同彼金湯。）</ail>
護法篇第五<ail>（家有良吏。守藏何虞。法有名師。外禦其侮。）</ail>
感通篇第六<ail>（逆於常理。感而遂通。化于世間。觀之難測。）</ail>
遺身篇第七<ail>（難捨易捐。施中第一。以穢漏體。迴金剛身。）</ail>
讀誦篇第八<ail>（十種法師。此為高大。染枸櫞花。果時瓤赤。）</ail>
興福篇第九<ail>（為己為他。福生罪滅。有為之善。其利博哉。）</ail>
雜科聲德十<ail>（統攝諸科。同歸高尚。唱導之匠。光顯佛乘。）</ail>

/VOLSEP/
/SECTION:a_002/宋高僧傳卷第一
/TEXT030R/皇明天台山慈雲禪寺沙門釋如惺撰

/SECTION/譯經篇第一之一
/C/<a#_1>義淨</a><ord>一<ord>　　<a#_2>金剛智</a><ord>二<ord>　　<a#_3>不空</a><ord>三</ord>
