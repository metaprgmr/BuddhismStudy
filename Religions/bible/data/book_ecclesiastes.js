var theBook = createBibleBook(true, {
  "id":            "Eccl",
  "title":         { "en":"Ecclesiastes", "fr":"Ecclesiastes" },
  "chapter_count": 12,
  "langs":         [ "en", "fr" ],

  "descriptions": [
    "[Wikipedia] <p><b>Ecclesiastes</b> (Hebrew: קֹהֶלֶת‎, qōheleṯ; Greek: Ἐκκλησιαστής, Ekklēsiastēs) is one of the 24 books of the Tanakh (Hebrew Bible), where it is classified as one of the Ketuvim (Writings). Originally written c. 450–200 BCE, it is also among the canonical works of wisdom literature of the Old Testament in most denominations of Christianity. The title Ecclesiastes is a Latin transliteration of the Greek translation of the Hebrew Kohelet (also written as Koheleth, Qoheleth or Qohelet), the pseudonym used by the author of the book.</p>" +
    "<p>In traditional Jewish texts and throughout Christian church history (up to the 18th and 19th centuries), King Solomon is named as the author, but modern scholars reject this. The book is presented as the musings of a king of Jerusalem as he relates his experiences and draws lessons from them that are often self-critical. The author, who is not named anywhere in the book or anywhere else in the Bible, introduces a \"Kohelet\" whom he identifies as the son of David (1:1). The author does not use his own voice again until the final verses (12:9–14), where he gives his own thoughts and summarises the statements of the \"Kohelet\". The book emphatically proclaims that all the actions of human beings are inherently hevel, meaning \"vapor\" or \"breath\", but often interpreted as \"insubstantial\", \"vain\", or \"futile\", since the lives of both wise and foolish people all end in death. While Qoheleth clearly endorses wisdom as a means for a well-lived earthly life, he is unable to ascribe eternal meaning to it. In light of this perceived senselessness, he suggests that human beings should enjoy the simple pleasures of daily life, such as eating, drinking, and taking enjoyment in one's work, which are gifts from the hand of God. The book concludes with the injunction to \"Fear God, and keep his commandments; for that is the whole duty of everyone\". However, the lines are likely a later insertion meant to support the book's orthodoxy despite its overarching existential concerns (12:13).</p>" +
    "<i>Ecclesiastes</i> is a phonetic transliteration of the Greek word Ἐκκλησιαστής (Ekklesiastes), which in the Septuagint translates the Hebrew name of its stated author, Kohelet (קֹהֶלֶת). The Greek word derives from ekklesia (assembly) as the Hebrew word derives from kahal (assembly), but while the Greek word means \"member of an assembly\", the meaning of the original Hebrew word it translates is less certain. As Strong\"s concordance mentions, it is a female active participle of the verb kahal in its simple (Qal) paradigm, a form not used elsewhere in the Bible and which is sometimes understood as active or passive depending on the verb, so that Kohelet would mean \"(female) assembler\" in the active case (recorded as such by Strong\"s concordance,) and \"(female) assembled, member of an assembly\" in the passive case (as per the Septuagint translators). According to the majority understanding today, the word is a more general (mishkal קוֹטֶלֶת) form rather than a literal participle, and the intended meaning of Kohelet in the text is \"someone speaking before an assembly\", hence \"Teacher\" or \"Preacher\".</p>" +
    "<p>Ecclesiastes is presented as biography of \"Kohelet\" or \"Qoheleth\"; his story is framed by the voice of the narrator, who refers to Kohelet in the third person, praises his wisdom, but reminds the reader that wisdom has its limitations and is not man's main concern. Kohelet reports what he planned, did, experienced and thought, but his journey to knowledge is, in the end, incomplete; the reader is not only to hear Kohelet's wisdom, but to observe his journey towards understanding and acceptance of life's frustrations and uncertainties: the journey itself is important.</p>" +
    "<p>Few of the many attempts to uncover an underlying structure to Ecclesiastes have met with widespread acceptance; among them, the following is one of the more influential:</p>" +
    "<ul><li>Title (1:1)</li>" +
    "<li>Initial poem (1:2–11)</li>" +
    "<li>I: Kohelet's investigation of life (1:12–6:9)</li>" +
    "<li>II: Kohelet's conclusions (6:10–11:6)</li>" +
    "<li>Introduction (6:10–12)</li>" +
    "<li>A: Man cannot discover what is good for him to do (7:1–8:17)</li>" +
    "<li>B: Man does not know what will come after him (9:1–11:6)</li>" +
    "<li>Concluding poem (11:7–12:8)</li>" +
    "<li>Epilogue (12:9–14)</li></ul>" +
    "<p>Despite the acceptance by some of this structure, there have been many scathing criticisms, such as that of Fox: \"[Addison G. Wright's] proposed structure has no more effect on interpretation than a ghost in the attic. A literary or rhetorical structure should not merely 'be there'; it must do something. It should guide readers in recognizing and remembering the author's train of thought.\"</p>" +
    "<p>Verse 1:1 is a superscription, the ancient equivalent of a title page: it introduces the book as \"the words of Kohelet, son of David, king in Jerusalem.\"</p>" +
    "<p>Most, though not all, modern commentators regard the epilogue (12:9–14) as an addition by a later scribe. Some have identified certain other statements as further additions intended to make the book more religiously orthodox (e.g., the affirmations of God's justice and the need for piety).</p>",
  ],
...
theBook.addedTitles = {
  ...
  "1:12": "Wisdom Is Meaningless",
  "2:1":  "Pleasures Are Meaningless",
  "2:12": "Wisdom and Folly Are Meaningless",
  "2:17": "Toil Is Meaningless",
  "3:1":  "A Time for Everything",
  "4:1":  "Oppression, Toil, Friendlessness",
  "4:13": "Advancement Is Meaningless",
  "5:1":  "Standing in Awe of God",
  "5:8":  "Riches Are Meaningless",
  "7:1":  "Wisdom",
  "8:2":  "Obey the King",
  "9:1":  "A Common Destiny for All",
  "9:13": "Wisdom Better Than Folly",
  "11:1": "Bread Upon the Waters",
  "11:7": "Remember Your Creator While Young",
  "12:9": "The Conclusion of the Matter",
};
