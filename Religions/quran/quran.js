var quran = createQuranBook({
  ...
  "descriptions": [
    "English source: https://www.clearquran.com/001.html"
  ],

});

quran.chapter_titles = [
  /* 1 */  { "en":"The Opening",         "arx":"al-Fatihah"    },
  /* 2 */  { "en":"The Heifer",          "arx":"al-Baqarah"    },
  /* 3 */  { "en":"Family of Imran",     "arx":"Ali'Imran"     },
  /* 4 */  { "en":"Women",               "arx":"an-Nisa'"      },
  /* 5 */  { "en":"The Table",           "arx":"al-Ma'idah"    },
  /* 6 */  { "en":"Livestock",           "arx":"al-An'am"      },
  /* 7 */  { "en":"The Elevations",      "arx":"al-A'raf"      },
  /* 8 */  { "en":"The Spoils",          "arx":"al-Anfal"      },
  /* 9 */  { "en":"Repentance",          "arx":"at-Tawbah"     },
  /* 10 */ { "en":"Jonah",               "arx":"Yunus"         },
  /* 11 */ { "en":"Hud",                 "arx":"Hud"           },
  /* 12 */ { "en":"Joseph",              "arx":"Yusuf"         },
  /* 13 */ { "en":"Thunder",             "arx":"ar-Ra'd"       },
  /* 14 */ { "en":"Abraham",             "arx":"Ibrahim"       },
  /* 15 */ { "en":"The Rock",            "arx":"al-Hijr"       },
  /* 16 */ { "en":"The Bee",             "arx":"an-Nahl"       },
  /* 17 */ { "en":"The Night Journey",   "arx":"al-Isra'"      },
  /* 18 */ { "en":"The Cave",            "arx":"al-Kahf"       },
  /* 19 */ { "en":"Mary",                "arx":"Maryam"        },
  /* 20 */ { "en":"Ta-Ha",               "arx":"Ta-Ha"         },
  /* 21 */ { "en":"The Prophets",        "arx":"al-Anbiya"     },
  /* 22 */ { "en":"The Pilgrimage",      "arx":"al-Hajj"       },
  /* 23 */ { "en":"The Believers",       "arx":"al-Mu'minun"   },
  /* 24 */ { "en":"The Light",           "arx":"an-Nur"        },
  /* 25 */ { "en":"The Criterion",       "arx":"al-Furqan"     },
  /* 26 */ { "en":"The Poets",           "arx":"ash-Shu'ara'"  },
  /* 27 */ { "en":"The Art",             "arx":"an-Naml"       },
  /* 28 */ { "en":"History",             "arx":"al-Qasas"      },
  /* 29 */ { "en":"The Spider",          "arx":"al-'Ankabut"   },
  /* 30 */ { "en":"The Romans",          "arx":"ar-Rum"        },
  /* 31 */ { "en":"Luqman",              "arx":"Luqman"        },
  /* 32 */ { "en":"Prostration",         "arx":"as-Sajdah"     },
  /* 33 */ { "en":"The Confederates",    "arx":"al-Ahzab"      },
  /* 34 */ { "en":"Sheba",               "arx":"Saba'"         },
  /* 35 */ { "en":"Originator",          "arx":"Fatir"         },
  /* 36 */ { "en":"Ya-Seen",             "arx":"Ya-Seen"       },
  /* 37 */ { "en":"The Aligners",        "arx":"as-Saffat"     },
  /* 38 */ { "en":"Saad",                "arx":"Saad"          },
  /* 39 */ { "en":"Throngs",             "arx":"az-Zumar"      },
  /* 40 */ { "en":"Forgiver",            "arx":"Ghafir"        },
  /* 41 */ { "en":"Detailed",            "arx":"Fussilat"      },
  /* 42 */ { "en":"Consultation",        "arx":"ash-Shura"     },
  /* 43 */ { "en":"Decorations",         "arx":"az-Zukhruf"    },
  /* 44 */ { "en":"Smoke",               "arx":"ad-Dukhan"     },
  /* 45 */ { "en":"Kneeling",            "arx":"al-Jathiyah"   },
  /* 46 */ { "en":"The Dunes",           "arx":"al-Ahqaf"      },
  /* 47 */ { "en":"Muhammad",            "arx":"Muhammad"      },
  /* 48 */ { "en":"Victory",             "arx":"al-Fath"       },
  /* 49 */ { "en":"The Chambers",        "arx":"al-Hujurat"    },
  /* 50 */ { "en":"Qaf",                 "arx":"Qaf"           },
  /* 51 */ { "en":"The Spreaders",       "arx":"adh-Dhariyat"  },
  /* 52 */ { "en":"The Mount",           "arx":"at-Tur"        },
  /* 53 */ { "en":"The Star",            "arx":"an-Najm"       },
  /* 54 */ { "en":"The Moon",            "arx":"al-Qamar"      },
  /* 55 */ { "en":"The Compassionate",   "arx":"ar-Rahman"     },
  /* 56 */ { "en":"The Inevitable",      "arx":"al-Waqi'ah"    },
  /* 57 */ { "en":"Iron",                "arx":"al-Hadid`"     },
  /* 58 */ { "en":"The Argument",        "arx":"al-Mujadilah"  },
  /* 59 */ { "en":"The Mobilization",    "arx":"al-Hashr"      },
  /* 60 */ { "en":"The Woman Tested",    "arx":"al-Mumtahina"  },
  /* 61 */ { "en":"Column",              "arx":"as-Saff"       },
  /* 62 */ { "en":"Friday",              "arx":"al-Jumu'ah"    },
  /* 63 */ { "en":"The Hypocrites",      "arx":"al-Munafiqun"  },
  /* 64 */ { "en":"Gathering",           "arx":"al-Taghabun"   },
  /* 65 */ { "en":"Divorce",             "arx":"at-Talaq"      },
  /* 66 */ { "en":"Prohibition",         "arx":"at-Tahrim"     },
  /* 67 */ { "en":"Sovereignty",         "arx":"al-Mulk"       },
  /* 68 */ { "en":"The Pen",             "arx":"al-Qalam"      },
  /* 69 */ { "en":"The Reality",         "arx":"al-Haqqah"     },
  /* 70 */ { "en":"Ways of Ascent",      "arx":"al-Ma'arij"    },
  /* 71 */ { "en":"Noah",                "arx":"Nuh"           },
  /* 72 */ { "en":"The Jinn",            "arx":"al-Jinn"       },
  /* 73 */ { "en":"The Enwrapped",       "arx":"al-Muzzammil"  },
  /* 74 */ { "en":"The Enrobed",         "arx":"al-Muddathir"  },
  /* 75 */ { "en":"Resurrection",        "arx":"al-Qiyamah"    },
  /* 76 */ { "en":"Man",                 "arx":"al-Insan"      },
  /* 77 */ { "en":"The Unleashed",       "arx":"al-Mursalat"   },
  /* 78 */ { "en":"The Event",           "arx":"an-Naba'"      },
  /* 79 */ { "en":"The Snatchers",       "arx":"an-Nazi'at"    },
  /* 80 */ { "en":"He Frowned",          "arx":"'Abasa"        },
  /* 81 */ { "en":"The Rolling",         "arx":"at-Takwir"     },
  /* 82 */ { "en":"The Shattering",      "arx":"al-Infitar"    },
  /* 83 */ { "en":"The Defrauders",      "arx":"al-Mutaffifin" },
  /* 84 */ { "en":"The Rupture",         "arx":"al-Inshiqaq"   },
  /* 85 */ { "en":"The Constellations",  "arx":"al-Buruj"      },
  /* 86 */ { "en":"The Nightly Visitor", "arx":"at-Tariq"      },
  /* 87 */ { "en":"The Most High",       "arx":"al-A'la"       },
  /* 88 */ { "en":"The Overwhelming",    "arx":"al-Ghashiyah"  },
  /* 89 */ { "en":"The Dawn",            "arx":"al-Fajr"       },
  /* 90 */ { "en":"The Land",            "arx":"al-Balad"      },
  /* 91 */ { "en":"The Sun",             "arx":"ash-Shams"     },
  /* 92 */ { "en":"The Night",           "arx":"al-Layl"       },
  /* 93 */ { "en":"Morning Light",       "arx":"adh-Duha"      },
  /* 94 */ { "en":"The Soothing",        "arx":"ash-Sharh"     },
  /* 95 */ { "en":"The Fig",             "arx":"at-Tin"        },
  /* 96 */ { "en":"Clot",                "arx":"al-'Alaq"      },
  /* 97 */ { "en":"Decree",              "arx":"al-Qadr"       },
  /* 98 */ { "en":"Clear Evidence",      "arx":"al-Bayyinah"   },
  /* 99 */ { "en":"Quake",               "arx":"az-Zalzalah"   },
  /* 100 */{ "en":"The Racers",          "arx":"al-'Adiyat"    },
  /* 101 */{ "en":"The Shocker",         "arx":"al-Qari'ah"    },
  /* 102 */{ "en":"Abundance",           "arx":"at-Takathur"   },
  /* 103 */{ "en":"Time",                "arx":"al-'Asr"       },
  /* 104 */{ "en":"The Backbiter",       "arx":"al-Humazah"    },
  /* 105 */{ "en":"The Elephant",        "arx":"al-Fil"        },
  /* 106 */{ "en":"Quraish",             "arx":"Quraysh"       },
  /* 107 */{ "en":"Assistance",          "arx":"al-Ma'un"      },
  /* 108 */{ "en":"Plenty",              "arx":"al-Kawthar"    },
  /* 109 */{ "en":"The Disbelievers",    "arx":"al-Kafirun"    },
  /* 110 */{ "en":"Victory",             "arx":"an-Nasr"       },
  /* 111 */{ "en":"Thorns",              "arx":"al-Masad"      },
  /* 112 */{ "en":"Monotheism",          "arx":"al-Ikhlas"     },
  /* 113 */{ "en":"Daybreak",            "arx":"al-Falaq"      },
  /* 114 */{ "en":"Mankind",             "arx":"ln-Nas"        },
];
...
quran.lang_en = [
  ...
  [ // 5
    ...
    "Had the People of the Scripture believed and been righteous, We would have remitted their sins, and admitted them into the Gardens of Bliss.",
    ...
    "O you who believe! You are responsible for your own souls. He who has strayed cannot harm you if you are guided. To God is your return, all of you, and He will inform you of what you used to do.",
  ...
  [ // 13
    ...
    "Is he who knows that what was revealed to you from your Lord is the truth, like him who is blind? Only those who reason will remember.",
  ...
  [ // 22
    ...
    "As for those who disbelieve and repel from God’s path and from the Sacred Mosque—which We have designated for all mankind equally, whether residing therein or passing through—and whoever seeks to commit sacrilege therein—We will make him taste of a painful punishment.",
  ...
  [ // 64
    ...
    "O you who believe! Among your spouses and your children are enemies to you, so beware of them. But if you pardon, and overlook, and forgive—God is Forgiver and Merciful.",
