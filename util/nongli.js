...
class NL2027 extends NongLiYear {
  constructor(events) {
    super(2027, [ 2, 6, 6 ], [ 30, 30, 29, 30, 29, 29, 30, 29, 29, 30, 30, 29 ],
      [ // 節氣: 陽曆日子                                                           2026 << ['小寒',2026, 1, 5], ['大寒',2026, 1,20],
        ['立春',2027, 2, 4], ['雨水',2027, 2,19], ['驚蟄',2027, 3, 6], ['春分',2027, 3,21], ['清明',2027, 4, 5], ['穀雨',2027, 4,20],
        ['立夏',2027, 5, 6], ['小滿',2027, 5,21], ['芒種',2027, 6, 6], ['夏至',2027, 6,21], ['小暑',2027, 7, 7], ['大暑',2027, 7,23],
        ['立秋',2027, 8, 8], ['處暑',2027, 8,23], ['白露',2027, 9, 8], ['秋分',2027, 9,23], ['寒露',2027,10, 8], ['霜降',2027,10,23],
        ['立冬',2027,11, 7], ['小雪',2027,11,22], ['大雪',2027,12, 7], ['冬至',2027,12,22], ['小寒',2028, 1, 6], ['大寒',2028, 1,20],
        ['立春',2028, 2, 4], // >> 2028
      ], events);
  }
};

const NLYearDefs = [ NL2023, NL2024, NL2025, NL2026, NL2027 ];
