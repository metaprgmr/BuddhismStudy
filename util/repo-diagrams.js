...
createGP('五蘊假合之身', CAT_唯識).setLayout(
`色──物質組合—物—色
受─┐
想─┼精神組合—心—名
行─┤
...
createGP('大乘|菩薩修行五位', CAT_大乘) // 唯識宗所立。比較律宗所立之「四位」。
.setLayout(`
...
createGP('二諦四重', CAT_大乘).setLayout(`
...
createGP('修禪定外方便', CAT_大乘)
.setMarkNames('甲乙丙丁戊己庚辛壬癸')
.setLayout( `
...
　　└道諦─┤行：　（由此萬行，以趣涅槃。）
　　　　　　└出：　（由此聖道，以出生死。）`)
  .FO(2,2.5,14.5).XFT(1,[6,12],0,-0.5) // 四諦十六行相
  .FO(6,1,4)   // 苦諦
  .FO(6,5,8)   // 集諦
  .FO(6,9,12)  // 滅諦
  .FO(6,13,16) // 道諦
