...
〇〇〇〇〇〇〇〇〇〇〇〇〇楞嚴七大`);
  ...
  function 楞嚴七大() {
    gp.XFT(m,[2,3,10,11,14,15],0,0.5)     // move all 3 texts
      ...
      .L([m-2,15],"%r1")                  // 根大
      .PTR([m,18],"%u1",{endType:'arrow'}).L([m,18],"%l1")  // 楞嚴七大
  }
...
識─┘`)
    .L([2,1],"%r1.25")
    .FI(2,2,5,4).XFT(4,3,0,0.5)
    .src = js;
});

createGP('我我所', CAT_唯識, gp => {
  gp.setLayout(
`識──主觀的能認識的主體—我
色─┐
受─┼客觀的所認識的物件—我所
...
createGP('意識了別作用', CAT_唯識, gp => {
  gp.setLayout( // e corresponds to 十八界's 六識 colume
/* -- variables for key positions
e   f               g       h i       j    */ `
...
createGP('五法事理唯識', CAT_唯識, gp => {
  gp.setLayout(`
五
法〇┌ 心王〇〇 ── 識之自相┐
事〇├ 心所〇〇 ── 與識相應┤
理─┼ 色〇〇〇 ── 識之所變┼─事──不離識；萬法唯識
唯〇├ 不相應行 ── 識之分位┘〇〇〇〇〇│
識〇└ 無為〇〇 ─ 以上四法實性─理───┘
`)
    .XFT(1, [1,'-',6], 0, 0.5)
    ...
    .FI(17,2,5,4)
    .L([17,6],"%r1.25")
    .XFT([19,'-',22],4,0,-0.5) // 事、理
    .L([20,4],"%r1")
    .L([20,6],"%r3").L([23,6],"%u1.75")
    .src = js;
});

createGP('五重唯識', CAT_唯識, gp => {
  gp.setLayout(`
五〇〇１遣虛存寶（空有相對，遣空存有）
重〇〇２捨濫留純（心境相對，捨境留心）〇〇唯識相
唯〇〇３攝末歸本（體用相對，攝用歸體）
識〇〇４隱劣顯勝（王所相對，隱所顯王）
觀〇〇５遣相證性（事理相對，遣事證理）〇〇唯識性`)
    .FO(2,1,5)  // 五重唯識觀
    .XFT(22,2,0,0.5).FI(20,1,4) // 唯識相
    .L([20,5],"%r1")   // 唯識性
    .src = js;
});

createGP('八識具緣', CAT_唯識, gp => {
  gp.setLayout(`
...
createGP('八識及能變體', CAT_唯識, gp => {
  gp.setStyle(AIL + BOLD)
    .setLayout(`
〇〇１眼識〇〇眼根緣色塵〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇　/b|八識能變體/
〇〇２耳識〇〇耳根緣聲塵
〇〇３鼻識〇〇鼻根緣香塵〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇識（了別）〇七〇〇〇第三能變識：了別
〇〇４舌識〇〇舌根緣味塵〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇轉〇　　　/ail|六識各各了別各種粗顯/
〇〇５身識〇〇身根緣觸塵〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇識〇〇〇〇/ail|外境，名了別境識。/
八〇６意識〇〇意根緣法塵〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇
識〇〇〇末〇〇是第六意識所依之根〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇
〇〇７〇那〇〇常隨四煩惱：我癡、我見、我愛、我慢〇〇〇意（思量）〇〇〇〇〇第二能變識：思量
〇〇〇〇識〇〇向內執取阿賴耶為我，向外認識境界為實法〇〇〇〇〇〇〇〇〇　　　/ail|恆持第八識的見分為/
〇〇〇〇〇〇〇〇〇〇〇〇〇能藏：能含藏一切法的種子〇〇〇〇〇〇〇〇〇〇　　　/ail|自我而審察思量。/
〇〇〇〇阿〇〇華譯藏識〇〇所藏：受第七識所薰習〇〇〇〇〇〇〇〇〇〇根
〇〇８〇賴〇〇〇〇〇〇〇〇執藏：受第七識所執取〇〇〇〇心（集起）〇本〇〇〇第一能變識：異熟
〇〇〇〇耶〇〇無覆無記〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇識〇　　　/ail|異時而熟、變異而熟、/
〇〇〇〇〇〇〇種子現行時，善惡分明，業報相續〇〇〇〇〇〇〇〇〇〇〇〇〇　　　/ail|異類而熟。/`)
    .setWidth(46)
    ...
    .L([37,1],"%l1").L([37,6],"%l1").L([37,1],[37,6])
  //.L([37,2],"%l1").L([37,3],"%l1").L([37,4],"%l1").L([37,5],"%l1")
    .L([37,8],"%l1")                                    // 第二能變識
    .L([37,12],"%l1")                                   // 第一能變識
    .src = js;
});

createGP('識體四分', CAT_唯識, gp => {
  gp.setLayout(`
　　　　 ┌見分：　　八識識體主能觀的認識的功能。
識體四分─┼相分：　　為見分所認識的影像。
　　　　 ├自證分：　識體證知見分所見有無謬誤的功能。
...
createGP('種子分類', CAT_唯識, gp => {
  gp.setStyle(AIL)
    .setLayout(`
依〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇┌名言種子/ail|：表義名言，即等流種子；名言習氣/
〇漏無〇〇〇┌有漏種子；善、不善、無記種子─┼我執種子/ail|：顯境名言；〰〰〰〰〰〰我見習氣/
〇〇〇分類─┤〇三界六道眾生輪迴生死的種子。└有支種子/ail|：業種子，亦名異熟種子；有支習氣/
〇三性〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇┌生空無漏種子/ail|：屬見道位無漏種子/
〇〇〇〇〇〇└無漏種子；純善種子〇〇〇〇〇─┼法空無漏種子/ail|：屬修道位無漏種子/
〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇└二空無漏種子/ail|：為無學道無漏種子/
〇〇〇〇〇〇〇〇大乘菩薩轉染成淨、修行證果的種子。
〇〇〇〇〇〇┌本有種子/ail|：本性住種，是無始以來法爾本具的，是先天本有的。/
依生起分類─┤
〇〇〇〇〇〇└新薰種子/ail|：習所成種，是種子生起現行，受現行薰習而成的新種子。/`)
    .setWidth(40)
    .XFT([4,6],3,0,0.5) // 依有無漏 依三性 分類
    .XFT(1,1,0,2.5)
    .XFT(2,2,0,1)
    .FO(6,2,5)    // 依有無漏 依三性 分類
    .FO(22,1,3,3) // 有漏
    .FO(22,4,6,3) // 無漏
    .XFT(9,7,0,-1)
    .TC(9,3,'ail')
...
　　　　　勝義無自性　　勝義是二空所顯真如，真如若有自性，就不是絕對的勝義了。`)
    .FO(4,1,3,3) // 三自性
    .L([12,1],"%l1.5")
    .L([10,2],"%r2")
    .L([10,3],"%r2")
...
createGP('三性中道', CAT_唯識, gp => {
  gp.setLayout(
/* -- variables for key positions
a     b             c       d       e       f     g             h           i       j    */ `
〇〇〇〇〇〇〇〇〇〇情有〇〇非空
〇〇〇遍計所執性〇〇〇〇〇〇〇〇〇〇中道〇〇〇〇〇遍計所執性〇〇體相都無〇〇非有        ## A
三〇〇〇〇〇〇〇〇〇理無〇〇非有〇〇〇〇〇〇三
性〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇性
各〇〇〇〇〇〇〇〇〇假有〇〇非空〇〇〇〇〇〇對
具〇〇依他起性〇〇〇〇〇〇〇〇〇〇〇中道〇〇望〇〇依他起性〇〇〇如幻假有〇〇非空〇〇〇中道 ## B
中〇〇〇〇〇〇〇〇〇實無〇〇非有〇〇〇〇〇〇中
道〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇道
〇〇〇〇〇〇〇〇〇〇真實〇〇非空
〇〇〇圓成實性〇〇〇〇〇〇〇〇〇〇〇中道〇〇〇〇〇圓成實性〇〇〇真空妙有                 ## C
〇〇〇〇〇〇〇〇〇〇無相〇〇非有`);

  gp.setStyle(AIL);
  gp.height = 13;
  var a=1, b=a+3, c=b+7, d=c+4, e=d+4, f=e+4, g=f+3, h=g+7, i=h+6,
      A=2, B=6, C=10;
  function 三性各具中道() {
...
createGP('三境|三量|三受|三性', CAT_唯識, gp => {
  gp.setLayout(`
...
　　　  　　　　　　　　唯第八識是無覆無記。`);
  ...
  gp.FO(3,1,3,3)   // 三境
    ...
    .FO(3,13,17,3) // 三受
    .L([6,D+3],"%r2")                    // 無覆無記
    .L([6,D+4],"%u1.5").L([6,D+4],"%r2") // 無覆無記
    .src = js;
});

createGP('心所法', CAT_唯識, gp => {
  gp.setLayout(
/* variables
a   b         c                   v   w                           u z     x   y     d */ `
〇〇遍行：〇〇觸、作意、受、想、思〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇五
〇〇別境：〇〇欲、勝解、念、定、慧〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇五
/b1|心/〇善：〇〇〇信、精進、慚、愧、無貪、無瞋、無癡、輕安、不放逸、行捨、不害〇〇〇〇十一〇五
/b1|所/〇根本煩惱：貪、瞋、癡、慢、疑、惡見〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇六〇十
/b1|法/〇隨煩惱：〇小十：忿、恨、惱、覆、誑、諂、憍、害、嫉、慳，中二：無慚、無愧，〇〇〇〇〇一
...
createGP('五位百法', CAT_唯識, gp => { // compare: 七十五法（小乘）
  gp.setMarkNames('A')
    .setLayout(
/* variables are for 心所法()
    a   b         c                   v   w                           u z     x y       d   e  */ `
〇〇/b1|心王法/：〇〇〇眼識、耳識、鼻識、舌識、身識、意識、末那識、阿賴耶識〇〇〇〇〇〇〇〇〇八
〇
〇
〇
〇
/b2|宇/〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇/b|有/〇/b2|百/
/b2|宙/〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇/b|為/
/b2|萬/〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇/b|法/〇/b2|法/
/b2|有/〇/b1|色法/：〇〇〇〇眼、耳、鼻、舌、身、色、聲、香、味、觸、法處所攝色〇〇〇〇〇〇〇〇〇十一
〇〇〇〇〇〇〇〇〇得、命根、眾同分、異生性、無想定、滅盡定、無想報、
〇〇A〇〇〇〇〇〇名身、句身、文身、生、住、老、無常、流轉、定異、〇〇〇〇〇〇〇〇〇〇廿四
〇〇〇〇〇〇〇〇〇相應、勢速、次第、時、方、數、和合性、不和合性
〇〇/b|無為法/：〇〇〇虛空無為、擇滅無為、非擇滅無為、不動滅無為、想受滅無為、真如無為〇〇〇六`);

  function 不相應法行法() {
    var A = gp.getMark('A');
    gp.T(A[0], A[1], "/b1|不相應法行法：/")
      .XFT(3,10,0,0.5).XFT(4,11,0,0.5)
      .XFT(9,10,0,-0.25)
...
// Annotation for 五位百法
createGP('一切法無我', CAT_唯識, gp => {
  gp.setStyle(BOLD)
    .setLayout(`
〇〇〇〇〇〇/b|有為法/〇〇/b1|心王法/〇〇〇〇〇/blue|一切最勝/

/b|宇/〇〇〇〇〇〇〇〇〇〇/b1|心所法/〇〇〇〇〇/blue|與此相應/〇〇〇/b2|一/
/b|宙/〇〇/b|百/〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇/b2|切/
/b|萬/〇〇/b|法/〇〇〇〇〇〇〇/b1|色法/〇〇〇〇〇〇/blue|二所現影/〇〇〇/b2|法/
/b|有/〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇/b2|無/
〇〇〇〇〇〇〇〇〇〇〇/b1|不相應法行法/〇〇/blue|三位差別/〇〇〇/b2|我/

〇〇〇〇〇〇/b|無為法/〇〇〇〇〇〇〇〇〇〇/blue|四所顯示/
`);
  ...
  // 宇宙玩法、百法
  gp.XFT(1,[3,4,5,6],0,0.5) // 宇宙玩法
    .XFT(4,[4,5],0,0.5)     // 百法
    .L([1.75,5], '%r1.25');

  // 一二三四
  gp.setDefaultLineColor('blue')
    .L([19,1], '%l4')
    .L([19,3], '%l4')
    .L([19,5], '%l5')
    .L([19,7], '%l1')
  ...
  // 一切法無我
  gp.setDefaultLineColor('red')
    .L([25,1], '%r2').L([27,1], '%d1')
    .L([25,9], '%r2').L([27,9], '%u1');
});


createGP('六根本煩惱|十使', CAT_唯識, gp => {
  gp.setStyle(AIL)
    .setMarkNames('ABCD')
    .setLayout(`
　　┌　１貪──貪愛五欲（財色名食睡）─────────┐
...
　　　　　　└─５戒禁取見────執持不正戒，非因計因─┘`)
    ...
    .L([7,6],[7,10])
    .T(13.2,3.7,'/ail|（慢、過慢、過過慢、我慢、/')
    .T(14.0,4.3,'/ail|增上慢、卑劣慢、邪慢）/')
    .src = js;
});

createGP('阿賴耶識相應心所', CAT_唯識, gp => {
  gp.setStyle(AIL + BOLD)
    .T(1, 1, '阿賴耶識只相應五遍行心所。')
    .include(cloneGP('心所法')
...
createGP('前五識頌', CAT_唯識, gp => {
  gp.setStyle(BOLD)
    .setLayout(`
〇〇〇┌─境————性境。
〇〇〇├─量————現量。
〇〇〇├─三性———通善、惡、無記三性。
〇〇〇├─界地———眼、耳、身三識通欲界五趣雜居地、色界離生喜樂地。
〇〇〇│〇〇〇〇〇〇鼻、舌二識唯通五趣雜居地。
前五識┼─相應心所—遍行五、別境五、善十一、根本煩惱三（貪、嗔、癡）、
〇〇〇│〇〇〇〇〇〇中隨煩惱二、大隨煩惱八。
〇〇〇├─依緣———眼識九緣、耳識八緣、鼻、舌、身三識七緣。
〇〇〇├─業用———眼、耳二識之離中取境，鼻、舌、身三識合中取境。
〇〇〇├─斷惑———第八識轉識成智時，根成無漏，前五識亦轉為成所作智。
〇〇〇└─果用———分為三類化身，教化眾生，永息苦輪。

〇〇〇〇/b1|性境現量通三性，眼耳身三二地居，遍行別境善十一，中二大八貪嗔癡。/
〇〇〇〇/b1|五識同依淨色根，九緣七八好相鄰，合三離二觀塵世，愚者難分識與根。/
〇〇〇〇/b1|變相觀空唯後得，果中猶自不詮真，圓明初發成無漏，三類分身息苦輪。/`)
    .FO(4,1,11,[2,3,4,6,8,9,10,11])
    .src = js;
});

createGP('第六識頌', CAT_唯識, gp => {
  gp.setStyle(BOLD)
    .setLayout(`
〇〇〇┌─境————通於性境、帶質境、獨影境三境。
〇〇〇├─量————通於現量、比量、非量三量。
〇〇〇├─三性———通於善、惡、無記三性。
〇〇〇├─界地———通於欲界、色界、無色界三界。
〇〇〇├─相應心所—五十一個心所全部與之相應。
〇〇〇├─依緣———依境、作意、染淨依、根本依、種子依五緣。
第六識┼─體相———隨念分別、計度分別、自性分別。
〇〇〇├─業用———動身發語，造引滿美，招輪迴三界果報，三性、五受變易。
〇〇〇├─斷惑———資糧位中，漸伏我、法二執種子現行。
〇〇〇│〇〇〇〇〇〇見道位中，分別起的我法二執種子斷滅，在初地中轉為下品妙觀察智、
〇〇〇│〇〇〇〇〇〇修道位中，伏斷俱生起的我法二執現行種子。
〇〇〇│〇〇〇〇〇〇遠行地後，俱生起的我執種子斷滅，成純無漏。
〇〇〇│〇〇〇〇〇〇等覺位，俱生起的法執種子斷滅，轉為妙觀察智。
〇〇〇└─果用———智照大千內眾生機宜，隨應說法。

〇〇〇〇/b1|三性三量通三境，三界輪時易可知，相應心所五十一，善惡臨時別配之。/
〇〇〇〇/b1|性界受三恒轉易，根隨信等總相連，動身發語獨為最，引滿能招業力牽。/
〇〇〇〇/b1|發起初心歡喜地，俱生猶自現纏眠，遠行地後純無漏，觀察圓明照大千。/`)
    .FO(4,1,14,[2,3,4,5,6,7,8,9,14])
    .XFT(1,7,0,0.5)
    .src = js;
});

createGP('第七識頌', CAT_唯識, gp => {
  gp.setStyle(BOLD)
    .setLayout(`
〇〇〇┌─境————真帶質境。
〇〇〇├─量————非量。
〇〇〇├─三性———有覆無記
〇〇〇├─界地———欲界、色界、無色界。
〇〇〇├─相應心所—遍行五、別境一（慧）、善十一、根本煩惱四（貪、癡、慢、我見）、
〇〇〇│〇〇〇〇〇〇大隨煩惱八，共十八心所。
第七識┼─依緣———根（末那依阿賴耶為根據）、境（阿賴耶見分）、作意、根子依，共四緣。
〇〇〇├─體相———恒審思量，執著自我
〇〇〇├─業用———為前六轉識染淨之依。
〇〇〇├─斷惑———極喜地初心，俱生我法二執初伏，初轉下品平等性智。
〇〇〇│〇〇〇〇〇〇到第七遠行地後（八九十地），俱生我執永斷，轉中品平等性智。
〇〇〇│〇〇〇〇〇〇金剛喻定現前，俱生法執永斷，轉為上品平等性智。
〇〇〇└─果用———現起他受用身，以十地菩薩為所被機而教化之。

〇〇〇〇/b1|帶質有覆通情本，隨緣執我量為非，八大遍行別境慧，貪癡我見慢相隨。/
〇〇〇〇/b1|恒審思量我相隨，有情日夜鎮昏迷，四惑八大相應起，六轉呼為染淨依。/
〇〇〇〇/b1|極喜初心平等性，無功用行我恒摧，如來現起他受用，十地菩薩所被機。/`)
    .FO(4,1,13,[2,3,4,5,7,8,9,10,13])
    .XFT(1,6,0,0.5)
    .src = js;
});

createGP('第八識頌', CAT_唯識, gp => {
  gp.setStyle(BOLD)
    .setLayout(`
〇〇〇┌─境————無覆。
〇〇〇├─量————現量。
〇〇〇├─三性———無覆無記。
〇〇〇├─界地———欲、色、無色三界（隨他業力生）。
〇〇〇├─相應心所—遍行五。
第八識┼─依緣———根（以末那識為俱有依）、境（以根身、器界、種子為所緣境）、
〇〇〇│〇〇〇〇〇〇作意、種子依，共四緣。
〇〇〇├─體相———浩浩三藏不可窮。
〇〇〇├─業用———受薰，攝持種子、根身、器界，業力寄託、輪迴主體。
〇〇〇├─斷惑———不動地前（遠行地）俱生我執已斷，捨去藏識之名。金剛道後，
〇〇〇│〇〇〇〇〇〇俱生法執永斷，不感生死，空去異熟識之名。至此轉成「大圓鏡智」。
〇〇〇└─果用———圓明普照於十方世界，微塵剎土。

〇〇〇〇/b1|性唯無覆五遍行，界地隨他業力生，二乘不了因迷執，由此能興論主爭。/
〇〇〇〇/b1|浩浩三藏不可窮，淵深七浪境為風，受薰持種根身器，去後來先作主公。/
〇〇〇〇/b1|不動地前才舍藏，金剛道後異熟空，大圓無垢同時發，普照十方塵剎中。/`)
    .FO(4,1,12,[2,3,4,5,6,8,9,10,12])
    .XFT(1,6,0,0.5)
    .src = js;
});

createGP('三界之九地二十八天', CAT_基本, gp => {
  gp.setMarkNames('ABCDEFGH')
    .setLayout(`
〇〇〇〇〇（近）〇C〇五趣雜居地
...
createGP('二十八天', CAT_基本, gp => {
  gp.setLayout(`
（近）〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇（非天諸趣）
〇〇〇〇〇〇〇〇四王天〇〇〇〇〇〇〇〇〇〇〇〇地居天
〇〇〇〇欲〇〇〇忉利天
〇〇〇〇界〇〇〇夜摩天〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇五趣雜居地
〇〇〇〇天〇〇〇兜率天
〇〇〇〇〇〇〇〇化樂天〇〇〇〇〇〇〇〇〇〇〇〇空居天
〇〇〇〇〇〇〇〇他化自在天
〇〇〇〇〇〇〇〇梵眾天
〇〇〇〇〇〇初〇梵輔天〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇禪離生喜樂地
〇〇〇〇〇〇禪〇大梵天
〇〇〇〇〇〇〇〇少光天
〇〇〇〇〇〇二〇無量光〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇禪定生喜樂地
〇〇〇〇〇〇禪〇光音天
二〇〇〇色〇〇〇少淨天〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇九
十〇〇〇界〇三〇無量淨〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇禪離喜妙樂地
八〇〇〇天〇禪〇遍淨天〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇地
天〇〇〇〇〇〇〇無雲天
〇〇〇〇〇〇〇〇福生天
〇〇〇〇〇〇〇〇廣果天
〇〇〇〇〇〇〇〇無想天
〇〇〇〇〇〇四〇無煩天〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇禪捨念清淨地
〇〇〇〇〇〇禪〇無熱天〇〇〇〇〇〇〇〇〇〇〇〇五
〇〇〇〇〇〇〇〇善見天〇〇〇〇〇〇〇〇〇〇〇〇淨
〇〇〇〇〇〇〇〇善現天〇〇〇〇〇〇〇〇〇〇〇〇居
〇〇〇〇〇〇〇〇色究竟天〇〇〇〇〇〇〇〇〇〇〇天
〇〇〇〇無〇〇〇空無邊處天〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇空無邊處地
〇〇〇〇色〇〇〇識無邊處天〇〇〇〇〇〇〇〇〇〇四〇〇〇〇識無邊處地
〇〇〇〇界〇〇〇無所有處天〇〇〇〇〇〇〇〇〇〇空〇〇〇〇無所有處地
（遠）〇天〇〇〇非想非非想處天〇〇〇〇〇〇〇〇天〇〇〇〇非想非非想處地`)
    .setStyle(AIL)
    .XFT(5, [3,4,5], 0, 0.5)
    .XFT(1, [14,'-',17], 0, -0.5)
    .XFT([3,6], 4, 0, 0.5)
    ...
    .L([22,5], "%r1")
    .L([21,4], "%r1")   // 天居天
    .L([22,4], "%d4").L([22,8], "%d4", 'stroke="black" stroke-dasharray="5"')
    .L([22,6], "%r1")
    .L([5,9],"%r1").L([5,21],"%r1")   // 色界天 enclosure
    .L([5,9],"%d4.25").L([5,21],"%u4.25")
    .L([7.75,8], "%r0.5").L([7.75,9], "%r0.5").L([7.75,10], "%r0.5")   // 初禪 fanout
    .L([7.75,8], "%d2")
    .L([7.75,11], "%r0.5").L([7.75,12], "%r0.5").L([7.75,13], "%r0.5") // 二禪 fanout
    .L([7.75,11], "%d2")
    .L([7.75,14], "%r0.5").L([7.75,15], "%r0.5").L([7.75,16], "%r0.5") // 三禪 fanout
    .L([7.75,14], "%d2")
    .L([7.75,17], "%r0.5")  // 四禪 fanout
    .L([7.75,18], "%r0.5")
    .L([7.75,19], "%r0.5")
    .L([7.75,20], "%r0.5")
    .L([7.75,21], "%r0.5")
    ...
    .L([7,26],  "%d3")
    .L([6,27],  "%r1")
    .XFT(24, [22,'-',25], 0, -0.5) // 五淨居天 fanin
    .L([21,21], "%r1")
    .L([21,25], "%r1")
    .L([22,21], "%d4")
    .L([22,23], "%r1")
    .XFT(24, [27,'-',29], 0, -0.5) // 四空天 fanin
    .L([21,26], "%r1")
    .L([21,29], "%r1")
    .L([22,26], "%d3")
    .L([22,27.5], "%r1")
    .L([27,1], "%l1").L([27,7], "%l1").L([27,1],[27,7]).L([27,4],"%r1")      // 五趣雜居地
    .L([27,8], "%l1").L([27,10], "%l1").L([27,8],[27,10]).L([27,9],"%r1")    // 禪離生喜樂地
    .L([27,11], "%l1").L([27,13], "%l1").L([27,11],[27,13]).L([27,12],"%r1") // 禪定生喜樂地
    .L([27,14], "%l1").L([27,16], "%l1").L([27,14],[27,16]).L([27,15],"%r1") // 禪離喜妙樂地
    .L([27,17], "%l1").L([27,25], "%l1").L([27,17],[27,25]).L([27,21],"%r1") // 禪捨念清淨地
    .L([26,26], "%r2") // 空無邊處地
    .L([26,27], "%r2") // 識無邊處地
    .L([26,28], "%r2") // 無所有處地
    .L([26,29], "%r2") // 非想非非想處地
    .L([38,4],"%l1").L([38,29],"%l1").L([38,4],[38,13]).L([38,17],[38,29])   // 九地
    // 诸天别名
    .T(14, 7,"/ail|（天魔天）/")
    .T(13,25,"/ail|（摩醯首罗，阿迦尼吒）/")
    .src = js;
});

createGP('大乘|菩薩修行五位', CAT_大乘, gp => { // 唯識宗所立。比較律宗所立之「四位」。
  gp.setLayout(`
〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇/b|菩薩修行五位/
...
〇〇〇妙覺〇〇〇〇〇〇〇〇〇〇〇〇〇究竟位（證得佛果）`)
    ...
    .XFT(12,6,0,0.5).FI(10,6,7)   // 四尋思觀
    .XFT(12,9,0,-0.5).FI(10,8,9)  // 四如實智
...
createGP('二諦四重', CAT_大乘, gp => {
  gp.setStyle(AIL)
    .setLayout(`
〇〇〇〇〇〇〇〇〇〇〇無體〇〇〇〇〇〇〇世間世俗諦
〇〇〇〇〇〇〇〇〇〇〇有體〇事〇〇〇〇〇道理世俗諦
有體無體之對〇〇〇〇〇〇〇〇理〇淺〇〇〇證得世俗諦
事理意義之對〇〇〇〇〇〇〇〇〇〇深〇詮〇勝義世俗諦
道理深淺之對〇〇〇〇〇有體〇事〇〇〇〇〇世間勝義諦
詮旨各別之對〇〇〇〇〇〇〇〇理〇淺〇〇〇道理勝義諦
〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇深〇詮〇證得勝義諦
〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇旨〇勝義勝義諦`)
    .setWidth(45)
    .FO(10,1,5) // 有體無體之對
    .FO(9,2,6)  // 事理意義之對
    .FO(8,3,7)  // 道理深淺之對
    ...
    .L([17.5,4], "%r0.75").L([19.5,4], "%r0.75")  // 勝義世俗諦
    .L([13.5,5], "%r0.75").L([15.5,5], "%r4.75")  // 世間勝義諦
    .L([15.5,6], "%r0.75").L([17.5,6], "%r2.75")  // 道理勝義諦
    .L([17.5,7], "%r0.75").L([19.5,7], "%r0.75")  // 證得勝義諦
    .L([19.5,8], "%r0.75")  // 勝義勝義諦
    .T(27,1,'/ail|又名有名無實諦。唯有假名，並無實體。/')
    .T(27,2,'/ail|又名隨事差別諦。即是五蘊、十二處、十八界等法。/')
    .T(27,3,'/ail|又名方便安立諦。循苦、集、滅、道四真理證得聖果。/')
    .T(27,4,'/ail|又名假名非安立諦。證得我空、法空二真如。/')
    .T(27,5,'/ail|又名體用顯見諦。/')
    .T(27,6,'/ail|又名自果差別諦。/')
    .T(27,7,'/ail|又名依門顯實諦。依二空聖智詮空門觀而顯的真理。/')
    .T(27,8,'/ail|又名廢詮歸旨諦。唯根本無分別智所證。/')
    .src = js;
});

createGP('四位', CAT_大乘, gp => { // compare: 大乘
  gp.setLayout(`
...
　　└究竟位　　漸進至於佛地，此當八地至妙覺。　為第三阿僧祇劫所修`)
    .FO(2,1,5)         // 四位
    .XFT(25,1,0, 0.5)  // 第一阿僧祇劫
    .FI(23,1,2)
    .XFT(25,3,0, 0.5)  // 第二阿僧祇劫
    .FI(23,3,4)
    .src = js;
});

createGP('六度', CAT_大乘, gp => {
  gp.setLayout(`
　　　　　　　　　　　六
　　　　　　　　　　　度
　┌─────────┴─────────┐
...
createGP('天台五時八教', CAT_大乘, gp => {
  gp.setLayout(
/*a         b           c         d         e     f         g  */`
〇化儀〇〇〇五時〇〇〇〇涅槃〇〇〇五時〇〇〇〇化法〇〇〇〇〇/h2|天台/
〇四教〇〇〇〇〇〇〇〇〇五味〇〇〇配化〇〇〇〇四教〇〇〇〇〇/h2|五時/
〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇/h2|八教/
...
〇/tip:非頓，非漸，非秘密，非不定|四非/〇〇〇法華〇〇〇〇醍醐味〇〇純〇〇〇〇〇圓教〇〇〇〇〇〇實 ## E
〇〇〇〇〇〇涅槃`);

  gp.setStyle(BOLD)
    .TC(31,1,'b').TC(31,2,'b').TC(31,3,'b')
    .TC(24,1,'b').TC(24,2,'b') // 化法四教
    .TC(2,1,'b').TC(2,2,'b')   // 化儀四教
    .TC(7,1,'b');  // 五時
...
createGP('天台綱宗', CAT_大乘, gp => {
  gp.setLayout(
/*  a b   c     d     e       f     g     h           i */ `
/h2|天台綱宗/〇〇〇〇〇〇藏（羊車）
〇〇〇〇〇〇化法〇〇通（鹿車）〇〇〇〇權
〇〇〇〇〇〇〇〇〇〇別（牛車）
〇〇〇教〇〇〇〇〇〇圓（大白牛車）〇〇實
〇〇〇〇〇〇〇〇〇〇頓
〇〇〇〇〇〇化儀〇〇漸〇〇〇〇〇〇〇〇〇〇〇〇為實施權
綱〇〇〇〇〇〇〇〇〇秘密〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇宗
〇〇〇〇〇〇〇〇〇〇不定〇〇〇〇〇〇〇〇〇〇〇開權顯實
〇〇〇〇〇〇〇〇〇〇分空觀
〇〇〇觀〇〇〇〇〇〇體空觀〇〇〇〇〇〇權
〇〇〇〇〇〇〇〇〇〇次第三觀
〇〇〇〇〇〇〇〇〇〇一心三觀〇〇〇〇〇實`);

  var a=3, b=a+1, c=a+3, d=a+6, e=a+9, f=e+4, g=f+3, h=g+3, i=h+6;
  gp.setStyle(BOLD).TC(1,1,'b') // (title)
    .FO(a-1,4.5,10.5).XFT(1,7,0,0.5) // 綱
    .XFT(b,[4,10],0,0.5)  // 教 觀 move down
    .FO(b+1,2.5,6.5)      // 教

    .FO(d,1,4,4).XFT(d-2,2,0,0.5)          // 化法 left
    .FI(g-1.5,1,3,3).L([g-1.5,4],"%r1.25") // 化法 right 權 實
    .FO(d,5,8,4).XFT(d-2,6,0,0.5)          // 化儀
    .FO(d,9,12,4).L([b+1,10.5],[d-0.25,10.5])  // 觀 left
    .FI(g-1.5,9,11,3).L([g-1.5,12],"%r1.25")   // 觀 right 權 實

    .L([h-1,2],[h+1,6]).L([h-1,10],[h+1,6]) // 權實
    .L([h-1,4],[h+1,8]).L([h-1,12],[h+1,8]) // 權實
    .FI(i,6,8) // 宗
    .src = js;
});

createGP('一心三觀', CAT_大乘, gp => {
  gp.setLayout(
/*      o   a     b             c       d         e         f         g         h */ `
/h2|不可思議/〇〇〇（三觀）（不思議境）（三諦）（破三惑）（證三智）（成三德）（教門）
/h2|一心三觀/
〇〇〇〇〇〇〇〇空觀〇一法一切法〇〇俗諦〇〇見思惑〇〇一切智〇〇般若德〇〇漸
〇〇〇〇生〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇菩
〇〇〇〇死〇〇〇假觀〇一切法一法〇〇真諦〇〇塵沙惑〇〇道種智〇〇解脫德〇〇頓〇〇〇〇提
〇〇〇〇煩〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇涅
〇〇〇〇惱〇〇〇中觀〇非一非一切〇〇中諦〇〇無明惑〇〇一切種智〇法身德〇〇不定〇〇〇槃`);

  gp.setStyle(BOLD)
    .TC(1,1,'b').TC(1,2,'b') // title bold
  var o=7, a=o+2, b=a+3, c=b+7, d=c+4, e=d+5, f=e+5, g=f+5, h=g+5;
...
createGP('修禪定外方便', CAT_大乘, gp => {
  gp.setMarkNames('甲乙丙丁戊己庚辛壬癸')
    .setStyle(AIL+BOLD)
    .setWidth(49)
    .setLayout( `
〇〇甲〇〇〇持戒清淨/ail|（佛法有二種健人：一者、不作諸惡，二者、作已能悔。）/
〇〇〇〇〇〇〇〇〇〇〇己衣具足/ail|（知量知足）/
〇〇〇〇〇〇衣食具足〇〇食具足/ail|（大士草果隨時，頭陀乞食，阿蘭若處檀越送食，僧中潔淨食）/
〇〇〇〇〇〇〇〇〇〇〇庚深山絕人處
〇〇〇〇〇〇閑居靜處〇〇頭陀蘭若處
〇〇〇〇〇〇〇〇〇〇〇〇清淨伽藍
〇〇〇〇〇〇〇〇〇〇〇辛息治生緣務/ail|（不作有為事業）/
〇〇〇〇〇〇〇〇〇〇〇〇息人間緣務/ail|（不追尋俗人朋友親戚知識，斷絕人事往還）/
〇〇〇〇〇〇息諸緣務〇〇息工巧技術緣務/ail|（不作世間工匠技術、醫方禁呪卜相書數算計等事）/
〇〇〇〇〇〇〇〇〇〇〇〇息學問緣務/ail|（讀誦聽學等悉皆棄捨）/
〇〇〇〇〇〇〇〇〇〇〇壬外護善知識/ail|（經營供養，善能將護行人，不相惱亂）/
〇〇〇〇〇〇近善知識〇〇同行善知識/ail|（共修一道，互相勸發，不相擾亂）/
〇〇〇〇〇〇〇〇〇〇〇〇教授善知識/ail|（以內外方便禪定法門，示教利喜）/
〇〇乙〇〇〇訶色欲〇癸〇/ail|此五欲者，得之轉劇，如火益薪，其焰轉熾。/
〇〇〇〇〇〇訶聲欲〇〇〇/ail|五欲無樂，如狗嚙枯骨。五欲增諍，如鳥競肉。/
〇〇訶欲〇〇訶香欲〇〇〇/ail|五欲燒人，如逆風執炬。五欲害人，如踐毒蛇。/
〇〇〇〇〇〇訶味欲〇〇〇/ail|五欲無實，如夢所得。五欲不久，假借須臾，如擊石火。/
〇〇〇〇〇〇訶觸欲〇〇〇/ail|智者思之，亦如怨賊。世人愚惑，貪著五欲，至死不捨，後受無量苦惱。/
〇〇丙〇〇〇棄貪欲蓋〇/ail|欲為種種惱亂住處。貪欲之人，去道甚遠。若心著欲，無由近道。/
〇〇〇〇〇〇棄瞋恚蓋〇/ail|瞋是失佛法之根本，墜惡道之因緣，法樂之冤家，善心之大賊，種種惡口之府藏。/
〇〇〇〇〇〇棄睡眠蓋〇/ail|如是惡法，最為不善。諸餘蓋情，覺故可除；睡眠如死，無所覺識；以不覺故，難可除滅。/
〇〇棄蓋〇〇棄掉悔蓋〇/ail|掉之為法，破出家人心。有三：身掉：身好遊走，諸雜戲謔，坐不暫安。/
〇〇〇〇〇〇〇〇〇〇〇/ail|〰〰〰〰〰〰〰〰〰〰〰〰〰〰口掉：好喜吟咏，競諍是非，無益戲論，世間語言等。/
〇〇〇〇〇〇〇〇〇〇〇/ail|〰〰〰〰〰〰〰〰〰〰〰〰〰〰心掉：心情放逸，縱意攀緣，思惟文藝，世間才技，諸惡覺觀等。/
〇〇〇〇〇〇棄疑蓋者〇/ail|以疑覆心故，於諸法中不得信心。信為能入；信心無故，於佛法中空無所獲。有三：疑自、疑師、疑法。/
〇〇丁〇〇〇調節飲食〇/ail|食若過飽，則氣急身滿，百脈不通，令心閉塞，坐念不安；若食過少，則身羸心懸，意慮不固。/
〇〇〇〇〇〇調節睡眠〇/ail|夫眠是無明惑覆，不可縱之。若其眠寐過多，非唯廢修聖法，亦復喪失功夫，而能令心闇昧，善根沈沒。/
〇〇〇〇〇〇調身、息、心〇/ail|欲入三昧，此三應合用，不得別說；但有初中後方法不同，是則入住出相有異也。/
〇〇〇〇〇〇〇〇/ail|一、調身者：不寬不急。縱在定外，行住進止，動靜運為，悉須詳審。欲入定：七支坐。/
〇〇〇〇〇〇〇〇/ail|二、調息者：不澁不滑。但求息相：不聲不結不麁，出入綿綿，若存若亡，資神安隱，情抱悅豫。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰〰〰三法調之：一、下著安心，二、寬放身體，三、想氣遍毛孔出入通同無障。/
〇〇〇〇〇〇〇〇/ail|三、調心者：不沈不浮不寬不急。有三義：入、住、出。/
〇〇〇〇〇〇〇〇/ail|〰〰入：一者、調伏亂想，不令越逸；二者、當令沈浮寬急得所。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰沈則當繫念鼻端，令心住在緣中，無分散意；浮則宜安心向下，繫緣臍中，制諸亂念。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰其定心亦有寬急之相：心有澁滑之相，推之可知。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰〰急病相者，由坐中攝心用念，因此入定，而上向胸臆急痛。當寬放其心，想氣皆流下，患自差矣。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰〰寬病相者，覺心志散慢身好逶迤；或口中涎流；或時闇晦。當歛身急念，令心住緣中；身體相持，以此為治。/
〇〇〇〇〇〇〇〇/ail|〰〰住：一坐之中，應須善識身息心三事調不調相。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰三者的無前後，隨不調者而調適之，令一坐之中，身息及心三事調適，無相乖越，和融不二。/
〇〇〇〇〇〇〇〇/ail|〰〰出：若坐禪將竟，欲出定時，應前放心異緣，開口放氣，想從百脈隨意而散，然後微微動身。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰次動肩、膊及手、頭、頸。次動二足，悉令柔軟。次以手遍摩諸毛孔。/
〇〇〇〇〇〇〇〇/ail|〰〰〰〰次摩手令煖，以揜兩眼，然後開之。待身熱稍歇，方可隨意出入。/
〇〇戊〇〇〇欲〇〇〇〇/ail|欲離世間一切妄想顛倒，欲得一切諸禪智慧法門故。亦名為志，亦名為願，亦名為好，亦名為樂。/
〇〇〇〇〇〇精進〇〇〇/ail|堅持禁戒，棄於五蓋，初夜後夜專精不廢，是名精進善道法。/
〇〇〇〇〇〇念〇〇〇〇/ail|念世間為欺誑可賤，念禪定為尊重可貴。若得禪定，即能具足發諸無漏智，成等正覺，廣度眾生，是為可貴。/
〇〇〇〇〇〇巧慧〇〇〇/ail|籌量得失輕重。世間之樂，樂少苦多，虛誑不實。禪定智慧之樂，無漏、無為，寂然閑曠，永離生死，與苦長別。/
〇〇〇〇〇〇一心分明〇/ail|明見世間可患可惡，善識定慧功德可尊可貴。爾時應當一心決定修行止觀，心如金剛，天魔外道不能沮壞。/
〇`);

  var 甲=gp.getMark('甲'), 乙=gp.getMark('乙'), 丙=gp.getMark('丙'), 丁=gp.getMark('丁'),
      戊=gp.getMark('戊'), 己=gp.getMark('己'), 庚=gp.getMark('庚'), 辛=gp.getMark('辛'),
      壬=gp.getMark('壬'), 癸=gp.getMark('癸');
  function fanoutLeft(refPt, type, name, height) {
    if (!height) height = 4;
    var x0=refPt[0], y0=refPt[1];
    gp.L([x0+2.5,y0],[x0+2.5,y0+height])
      .L([x0+2.5,y0],"%r0.5").L([x0+2.5,y0+height],"%r0.5")
      .L([x0+2.5,y0+height/2],"%l0.75")
      .XFT(x0+4,[3,9],0,-0.5);
    if (type) gp.VT(x0-2,y0+height/2-1.5,type);
    if (name) gp.T(x0,y0+height/2,name);
  }
  function 前提準備() {
    var x0=甲[0], y0=甲[1];
    fanoutLeft(甲, '前提準備', '具緣', 12);
    gp.FO(x0+8,2,3)
      .FO(x0+8,4,6,3)
      .FO(x0+8,7,10,4)
      .FO(x0+8,11,13,3);
  ...
  function 個人準備() {
    var x=丙[0]-2, yB=乙[1], yC=丙[1];
    fanoutLeft(乙);
    fanoutLeft(丙, null, null, 6);
    gp.T(x+2, yB+3, '/ail|對外境/')
      .T(x+2, yC+4, '/ail|對內擾/')
      .VT(x,(yB+yC+2)/2,'個人準備') // enclosure
      .L([x, yB+2], "%r0.5").L([x, yB+2], "%d0.75")
      .L([x, yC+3], "%r0.5").L([x, yC+3], "%u0.75")
      .L([癸[0]+0.5,癸[1]-0.25], "%d4.5", 'stroke="gray" stroke-dasharray="2"') // 訶欲 v-bar
    ;
  }

  gp.T(39,1,'/b|智者大師《小止觀》/')
    .T(44,3,'/b1|具緣第一/')
    .T(44,4,'/b1|訶欲第二/')
    .T(44,5,'/b1|棄蓋第三/')
    .T(44,6,'/b1|調和第四/')
  ...
  前提準備();
  個人準備();
  fanoutLeft(丁, '入禪準備', '調和', 16);
  fanoutLeft(戊, '精進準備', '方便');
  gp.src = js;
});

createGP('六和敬', CAT_基本, gp => {
  gp.setLayout(`
　理　和──證擇滅
　　　　　┌身口同住
　　　　　│口和無諍
...
`)
    ...
    .L([9,1], "%r1")
    .L([9,7], "%r1")
    .T(13,1.75,'srotāpanna')
    .T(13,3.75,'sakṛd-āgāmin')
    .T(13,5.75,'anāgāmin')
    .T(13,7.75,'arhat')
    .src = js;
});

createGP('聲聞乘', CAT_小乘, gp => {
  gp.setLayout(
/*  a           b         u          v         w */ `
〇〇〇〇〇〇〇〇〇五停心觀┐
〇〇〇〇外凡〇〇〇別相念處├─資糧位┐
〇〇凡〇〇〇〇〇〇總相念處┘〇三〇賢│〇〇〇─┐〇〇〇三
〇〇位〇〇〇〇〇〇暖───┐〇〇〇〇├〇七方便│〇〇〇生
〇〇〇〇內凡〇〇〇頂〇〇〇├─加行位┘〇〇〇〇│〇修〇乃
聲〇〇〇〇〇〇〇〇忍〇〇〇│〇四善根〇〇〇〇〇├─四〇至
聞〇〇〇〇〇〇〇〇世第一法┘〇〇〇〇〇〇〇〇〇│〇聖〇六
〇〇〇〇見道〇〇〇預流果〇┐〇〇〇〇〇〇〇〇〇│〇諦〇十
〇〇聖〇修道〇〇〇一來果〇├─四果位─────┘〇〇〇劫
〇〇位〇〇〇〇〇〇不還果〇│
〇〇〇〇無學道〇〇羅漢果〇┘`)
    .FO(8,1,3)  // 外凡
    .FO(8,4,7)  // 內凡
    .XFT(5,9,0,0.5).FO(8,9,10) // 修道
    .XFT([7,5,3],5,0,0.5)
    .L([3,2],"%r1").L([3,2],"%d0.5")      // 凡位
    .L([3,5],"%r1").L([3,5],"%u1")
    .L([7.75,8],"%r1.25")                 // 見道
    .L([8,11],"%r1")                      // 無學道
    .L([3,8],"%r1").L([3,8],"%d0.5")      // 聖位
    .L([3,11],"%r1").L([3,11],"%u0.5")
    .XFT(1,[3,9],0,0.5)                   // 聲聞
    .L([1,3],"%r1").L([1,3],"%d2")
    .L([1,9],"%r1").L([1,9],"%u2")
    .FI(14,1,3).XFT(16,[2,3],0,-0.5).XFT(18,3,0,-0.5) // 資糧位、三賢
    .FI(14,4,7)  // 加行位、四善根
    .FI(14,8,11).XFT(16,9,0,0.5) // 四果位
    .XFT(21,3,0,1) // text
    .FI(19,1,7)    // 七方便
    .FI(24,1,11)   // right
    .XFT(26,[5,'-',8],0,-0.5) // 三生乃至六十劫
    .src = js;
});

createGP('四聖諦', CAT_小乘, gp => {
  gp.setLayout(`
　　┌苦　諦（迷的果，即苦果）┐
四　│集　諦（迷的因，即苦因）┘─世間的因果
聖─┤滅　諦（悟的果，即樂果）┐
諦　└道　諦（悟的因，即樂因）┘─出世間的因果`)
    .XFT(1,[2,3,4],0,-0.5).FO(2,1,4) // 四聖諦
    .FI(16,1,2) // 世間的因果
    .FI(16,3,4) // 出世間的因果
    .XFT(18,[2,4],0,-0.5)
    .src = js;
...
createGP('三轉法輪', CAT_小乘, gp => {
  gp.setLayout(`
〇〇〇〇〇〇〇〇〇〇〇初轉〇示相：此是苦，逼迫性
〇〇〇苦諦〇〇苦果〇〇次轉〇勸修：此是苦，汝應知
〇〇〇〇〇〇〇〇〇〇〇三轉〇作證：此是苦，我已知
三〇〇〇〇〇〇〇〇〇〇初轉〇示相：此是集，招感性〇〇〇三
轉〇〇集諦〇〇苦因〇〇次轉〇勸修：此是集，汝應斷〇〇〇轉
四〇〇〇〇〇〇〇〇〇〇三轉〇作證：此是集，我已斷〇〇又十
聖〇〇〇〇〇〇〇〇〇〇初轉〇示相：此是滅，可證性〇〇稱二
諦〇〇滅諦〇〇樂果〇〇次轉〇勸修：此是滅，汝應證〇〇〇法
〇〇〇〇〇〇〇〇〇〇〇三轉〇作證：此是滅，我已證〇〇〇輪
〇〇〇〇〇〇〇〇〇〇〇初轉〇示相：此是道，可修性
〇〇〇道諦〇〇樂因〇〇次轉〇勸修：此是道，汝應修
〇〇〇〇〇〇〇〇〇〇〇三轉〇作證：此是道，我已修`)
    .L([6,2], "%r1").FO(10,1,3,3)     // 苦諦
    .L([6,5], "%r1").FO(10,4,6,3)     // 集諦
    .L([6,8], "%r1").FO(10,7,9,3)     // 滅諦
    .L([6,11],"%r1").FO(10,10,12,3)   // 道諦
    .XFT(1,[4,'-',8],0,0.5).FO(2,2,11,4)  // left
    .XFT(29,[4,'-',8],0,-0.5).FI(25,1,12) // right
    .src = js;
});

createGP('十二因緣', CAT_小乘, gp => {
  gp.setWidth(41)
    .setStyle(AIL)
    .setLayout(`
〇〇〇〇〇〇過去二因〇〇１〇〇無明（貪瞋痴等煩惱）〇〇〇〇惑 ▿
〇〇〇〇〇〇〇〇〇〇〇〇２〇〇行〇（造作諸業）〇〇〇〇〇〇業 ▾
〇〇〇〇〇〇〇〇〇〇〇〇３〇〇識〇（業識投胎）〇〇〇〇〇〇苦 ✗◂
〇〇〇〇〇〇〇〇〇〇〇〇４〇〇名色（但有胎形六根未具）〇〇苦 ✗◂
〇〇〇〇〇〇現在五果〇〇５〇〇六入（長成眼等六根人形）〇〇苦 ✗◂
十二因緣〇〇〇〇〇〇〇〇６〇〇觸〇（出胎與外境接觸）〇〇〇苦 ✗◂
三世因果〇〇〇〇〇〇〇〇７〇〇受〇（與外境接觸生苦樂感受）苦 ✗◂
〇〇〇〇〇〇〇〇〇〇〇〇８〇〇愛〇（對境生愛欲）〇〇〇〇〇惑 ▿
〇〇〇〇〇〇現在三因〇〇９〇〇取〇（追求造作）〇〇〇〇〇〇惑 ▿
〇〇〇〇〇〇〇〇〇〇〇〇１０〇有〇（成業因能招未來果報）〇業 ▾
〇〇〇〇〇〇未來二果〇〇１１〇生〇（再受未來五蘊身）〇〇〇苦 ▸✗
〇〇〇〇〇〇〇〇〇〇〇〇１２〇老死（未來之身又漸老而死）〇苦 ▸✗`)
    .FO(5,1.5,11.5)
    .XFT(7,[1,11],0,0.5) // 過去二因, 未來二果
    .L([5.5,5],"%r0.5").L([5.5,9],"%r0.5") // left
    .FO(11,1,2)     // 過去二因
    .FO(11,3,7)     // 現在五果
    .FO(11,8,10)    // 現在三因
    .FO(11,11,12)   // 未來二果
    ...
    .T(8, 9.75, '/ail|能生支/')
    .T(8,12.25, '/ail|所生支/')
    .FI(33.5,1, 7).VT(35.8,2,'第一重因果')
    .FI(33.5,8,12).VT(35.8,8,'第二重因果')
    .FI(37,  7, 9).VT(39.3,6.5,'淨土修行')
    .src = js;
});

createGP('七十五法', CAT_小乘, gp => { // compare: 五位百法
  gp.setStyle(BOLD) // title
    .setLayout(`
...
〇〇無為法：擇滅無為、非擇滅無為、虛空無為〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇〇三`)
    ...
    .L([4,7],"%d4").L([4,11],"%r1")
    .FO(10,1,3,3)   // 色法 fanout
    .FO(10,5,10,6)  // 心所法 fanout
    .XFT(6,7,0,0.5)
    // counts
...
createGP('七十五法與百法對照', CAT_小乘, gp => {
  gp.include(cloneGP('七十五法'), 1, 1)
    .include(cloneGP('五位百法'), 1, 16)
    .src = js;
});

createGP('八段五篇', CAT_戒律, gp => {
  gp.setLayout(`
...
function gp禪宗傳承(name, linkMap) {
  createGP(name || '禪宗傳承', CAT_大乘, gp => {
    gp.setStyle(AIL+BOLD)
      .setWidth(22)
      .setTree(`
/b|【禪宗傳承】/
〇${masterLink('','達摩','祖師')}→${masterLink('','慧可')}→${masterLink('','僧璨')}→${masterLink('','道信')}→${masterLink('','弘忍')}
!!〇→/ail| （衣缽相傳）/
