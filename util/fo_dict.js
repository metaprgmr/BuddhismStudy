...
addFoTerms('tuṣita',           '兜率天', '兜率', '兜率陀天', '都率天', '覩史多天', '兜率陀天', '率陀天',
                               '#', '知足天', '妙足天', '喜足天', '喜樂天');
addFoTerms('trayastriṁśa',     '忉利天', '#', '三十三天');
addFoTerms('śūnyatā',          '舜若多', '#', '空性');
addFoTerms('gāthā',            '伽他', '偈佗', '偈陀', '偈', '#', '偈頌');

addFoTerms('kāmadhātu',        '#', '慾界', 'Desire realm');
addFoTerms('rūpadhātu',        '#', '色界', 'Form realm');
addFoTerms('ārūpyadhātu',      '#', '無色界', 'Formless realm');
addFoTerms('sahāloka dhātu',   '娑婆世界', '索訶', '娑河', '#', '雜惡', '雜會', '忍土');
...
addFoTerms('vinaya',           '律', '#', '鼻那夜', '毘那耶', '毗尼', '毗尼耶', '鞞尼迦');
...
addFoTerms('deva',             '提婆', '#', '天', '天神');
addFoTerms('nāga',             '那伽', '#', '神龍');
addFoTerms('yakṣa',            '夜叉', '藥叉');
addFoTerms('gandharva',        '乾闥婆', '#', '香神', '樂神', '音樂神');
addFoTerms('asura',            '阿修羅'); // 四種阿修羅：鬼趣攝卵生、畜牲趣攝濕生、人趣攝胎生和天趣攝化生
addFoTerms('garuḍa',           '迦樓羅', '#', '大鵬金翅鳥');
