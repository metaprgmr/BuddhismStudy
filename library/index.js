...
function showThem(alt) {
  ...
  showNav();
  var ankorMap = {},
      ankors = [ '200=166', '400=383', '600=592', '800=780', '1000=999', '1200=1197',
                 '1400=1355', '1600=1598', '1800=1762', '2000=1977', '2100=2099',
                 9000, 9050, 9100 ];
      ankorMap = {};
...
<li>諸多文本之輸入略有年代，其時生僻字等常無字符對應，權以複合表達式替代。現代漢字字符集持續改善，譬如Hanozono、Jigmo、乃至未來更新者，故清除難字複合表達式甚為迫切。</li>
