...
class YPInfo
{
  ...
  toYP(ypColor, toneColor) {
    if (toneColor == ypColor) toneColor = null;
    var ret = this.consonant + this.vowel;
    if (toneColor) ret += '<font color="' + toneColor + '">' + this.tone + '</font>';
    else ret += this.tone;
    if (!ypColor) return ret;
    return '<font color="' + ypColor + '">' + ret + '</font>';
  }
...
class ZiInfo {
  ...
  addYP(yp) {
    if (this.yp) console.log('TODO: polyphone support', this.zi, this.yp, yp);
    this.yp = new YPInfo(yp);
  }
  getYP(ypColor, toneColor) { return this.yp.toYP(ypColor, toneColor); } // TODO: polyphone
  getConsonant() { return this.yp.consonant; }
  getConsonantTone(divider) { return this.yp.toConsonantTone(divider); }
  getFirstYP(ypColor, toneColor) { return this.yp.toYP(ypColor, toneColor); } // TODO: polyphone
  getFirstVowel() { return this.yp.vowel; } // TODO: polyphone
  getFirstConsonant() { return this.yp.consonant; } // TODO: polyphone
  getFirstConsonantTone(divider) { return this.yp.toConsonantTone(divider); } // TODO: polyphone
...
class YPDict {
  ...
  lookup(zi) {
    ...
    } else if (this.notAvailable.indexOf(zi) < 0) {
...
class LookupTool {
  ...
  lookup(zi) {
    ...
    if (zinfo) {
      ...
      if (this.firstN != null && zinfo.useCount > this.firstN)
...
(function() {
  ...
  var ignoreLevels = [
    toSet( // 0: polyphones, and the most frequent
      '佛相降' +
      '一二三四五六七八九十百千萬億第菩薩摩訶釋迦阿彌陀勒經世界尊王我汝他人' +
      '善來去剎光明法中上下東北西南今時間大小國土道方諸白是無不非未其如已此' +
      '在與同所謂真正者以為當曰現最雖故何但悉各有爾次之於乃亦或又并由而作則' +
      '及也即子可能必得常皆等唯耶生心金自令至盡反天地'),
  
    toSet( // 1: easy-to-recognize
      '聞山達難首普賢值葉士昧告往字那通力異意議固索剛平風男女雅紅芳用凡功德' +
    ...
    toSet( // 2: sutra-frequent:
      '信說頌海假提曾火莊嚴若死微妙行絕解脫始初成願復想言歎部切聲劫極樂定' +
      '滿教實色遠離眼比丘益漏盡含果見彼名歡喜受虛空決求音退猛忍開身登岸弘誓' +
      '俱胝授記轉出隨超養深乘友使救惡修誦讚演書寫譬恆處闇照獲久勤長利理門稱' +
      '導路孝植號從識悲哀惑壽歲過習勝耨藐威類精進日堅具劣瞻禮觀珍愛弟窮幾歸' +
      '增就輪迴豐田取分會聖集惟辯才究竟藏')
  ];
...
名而上首阿難薩會曰大比丘迦
meng2 ji4 soeng6 sau2 aa3 naan4 saat3 wui5 joek6 daai6 bei2 jau1 gaa1
普文殊師彌勒皆來第解脫觀緣起威光述
...
咸共遵修具足無量遊宣赫奕如融金聚在
haam4 gung6 zeon1 sau1 geoi6 zuk1 mou4 loeng6 jau4 syun1 haak1 jik6 jyu4 jung4 gam1 cou5 zoi6
理福田貯功德藥救療升灌頂階授菩提記為
lei5 fuk1 tin4 cyu5 gung1 dak1 joek6 gau3 liu4 sing1 gun3 ding2 gaai1 sau6 pou4 tai4 gei3 wai6
